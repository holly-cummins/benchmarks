...
public class GraphicsCommandTest {
    ...
    public void testLaunchWithFilename(LaunchResult result) {
        ...
        File image = new File("target/test-output/filename/data-main-throughput-light.svg");
    ...
    public void testLaunchWithUnqualifiedFilename(LaunchResult result) {
        ...
        File image = new File("target/test-output/filename/tempfile-main-throughput-light.svg");
        assertTrue(image.exists());
    }
    ...
    public void testLaunchWithRelativeOutputPath(LaunchResult result) {
        ...
        image = new File("target/test-output/filename/data-main-memory-rss-dark.svg");
        assertTrue(image.exists());
    }
    ...
    public void testLaunchWithDirectory(LaunchResult result) {
        ...
        File image1 = new File(dir, "data-main-throughput-light.svg");
        assertTrue(image1.exists());
        File image2 = new File(dir, "eight-framework-main-throughput-light.svg");
    ...
    public void testDarkMode(LaunchResult result) {
        ...
        File image = new File("target/test-output/filename/data-main-throughput-dark.svg");
        assertTrue(image.exists());
    }
